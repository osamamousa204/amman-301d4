...
//this 'this' reffers to the upper object which is Student
// 2. What is "this" when joe.scopeArrow() is invoked?
//this 'this' reffers to the window object which is window
// 3. Explain why "this" is different when an arrow function is used.
//because the old functions reffers to the upper object when we use 'this' inside it which in this case the scope function but when we use the arrow function it reffers to the window object by default which in this case the scopeArrow function thats why we should be carful when we use arrow functions with objects
