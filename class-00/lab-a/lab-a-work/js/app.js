...
function displayPics(){
  ...
  // 'let' declaration  works only in the same block '{}' so if we use it outside its scope it will throw an error but the 'var' declaration its a global scope works even if we use it outside the block
  console.log(viewed);
